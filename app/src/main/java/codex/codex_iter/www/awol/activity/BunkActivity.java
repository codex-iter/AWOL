...
public class BunkActivity extends BaseThemedActivity {
    ...
    private ArrayAdapter<String> dogsAdapter(String[] dogsArray) {
        ...
        return new ArrayAdapter<String>(BunkActivity.this, android.R.layout.simple_list_item_1, dogsArray) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                TextView listItem = new TextView(BunkActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub.setOnClickListener(view -> popupWindowDogs.showAsDropDown(view, 0, Math.round(getResources().getDisplayMetrics().density * 16)));
//        if (dark) {
...
//        });
        ...
        target.setOnClickListener(v -> {
                    ...
                    if (s.equals("0") || s_t > 100 || s.equals("00") || s.equals("000")) {
                        ...
                        Snackbar.make(findViewById(R.id.ll), "Enter Some Value", Snackbar.LENGTH_SHORT).show();
                    else if (s.equals("100") && absent > 0)
                        Snackbar.make(findViewById(R.id.ll), "Not Possible!!", Snackbar.LENGTH_SHORT).show();
                    else {
        ...
        bnkedt.setOnTouchListener((v, event) -> {
            taredt.setText("");
            atndedt.setText("");
            result.setText("");
            left.setText("");
        ...
        atndedt.setOnTouchListener((v, event) -> {
            bnkedt.setText("");
            taredt.setText("");
            result.setText("");
            left.setText("");
        ...
        taredt.setOnTouchListener((v, event) -> {
            bnkedt.setText("");
            atndedt.setText("");
            result.setText("");
            left.setText("");
